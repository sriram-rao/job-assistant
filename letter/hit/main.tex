...
\def\Where{\hspace{-1.2mm}\textbf{\color{HITblue}\myname}} 
%%%%%%%%%%%%  Additional Contact Information %%%%%%%%%%%
%
% Set your preferred primary contact address here.
%
\def\CityZip{\mylocation} 
%
% Set your HIT e-mail here
\def\Email{\textbf{\color{HITblue}E-mail}: 
\href{mailto:\myemail}{\myemail}}
%
% Set your preferred contact number here
\def\PhoneNumber{\phone}
\def\TEL{\textbf{\color{HITblue}Phone}: \href{tel:\PhoneNumber}{\PhoneNumber}}
%
% Set your department or personal website here
\def\URL{\textbf{\color{HITblue}LinkedIn}: \href{https://linkedin.com/in/\linkedin}{https://linkedin.com/in/\linkedin}}
%
%%%%%%%%%%%%%%%%  Footer information  %%%%%%%%%%%%%%%%%%
%
...
\begin{letter}{
    ...
    \node[text width=\textwidth] at (page cs:0,0.87){\small \noindent\rule{\textwidth}{0.7pt}};
    \end{tikzpicture} 
    \hspace{-2.5mm}\companyaddress
}
...
\node[text width=7cm] at (page cs:-0.77,0.66){\small \newaddress};
\end{tikzpicture} 
